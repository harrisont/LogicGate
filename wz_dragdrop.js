...
DDObj.prototype.moveBy = function(d_x, d_y, d_kds, d_o)
{
	...
	for (var i = 0; i < this.moveListeners.length; i++) {
		this.moveListeners[i].moved();
	}
};
DDObj.prototype.addMoveListener = function(listener)
{
	this.moveListeners.push(listener);
};
DDObj.prototype.addDragEndedListener = function(listener)
{
	this.dragEndedListeners.push(listener);
};
...
function DROP(d_ev)
{
	if(dd.obj)
	{
		...
		var dragEndedListeners = dd.obj.dragEndedListeners;
		for (var i = 0; i < dragEndedListeners.length; i++) {
			dragEndedListeners[i].dragEnded();
		}
...
{
	dd.obj.setOpacity(settings.dragOpacity);
}
